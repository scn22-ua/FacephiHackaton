...
def cargar_encoding_dni(dni_path):
    ...
    # Intentar primero con configuración normal (HOG, ligero)
    encodings = face_recognition.face_encodings(img)
    if encodings:
        return encodings[0]

    # Si no detecta, escalar la imagen x2 (caras pequeñas en DNI)
    scale = 2
    ...
    # Último intento: más upsampling con HOG (ligero, ~300-500MB RAM)
